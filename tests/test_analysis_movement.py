...
class TestMovementAnalysis:
    ...
    def test_speed_bucket_classification(self):
        ...
        players = [
            ...
            create_test_player(
                "player1", 0, velocity=Vec3(2500.0, 0.0, 0.0), is_supersonic=True
            ),
        ]
    ...
    def test_ground_vs_air_classification(self):
        ...
        players = [
            ...
            # Low air
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 100.0), is_on_ground=False
            ),
            # High air
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 600.0), is_on_ground=False
            ),
        ]
    ...
    def test_powerslide_detection(self):
        ...
        players = [
            # Starting position
            create_test_player(
                "player1", 0, rotation=Vec3(0.0, 0.0, 0.0), is_on_ground=True
            ),
            # High angular velocity (powersliding)
            create_test_player(
                "player1", 0, rotation=Vec3(0.0, 1.0, 0.0), is_on_ground=True
            ),
            create_test_player(
                "player1", 0, rotation=Vec3(0.0, 2.0, 0.0), is_on_ground=True
            ),
            create_test_player(
                "player1", 0, rotation=Vec3(0.0, 3.0, 0.0), is_on_ground=True
            ),
            # Back to normal
            create_test_player(
                "player1", 0, rotation=Vec3(0.0, 3.1, 0.0), is_on_ground=True
            ),
        ]
    ...
    def test_aerial_detection(self):
        ...
        players = [
            ...
            # Taking off
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 250.0), is_on_ground=False
            ),
            # High in air (aerial)
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 400.0), is_on_ground=False
            ),
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 500.0), is_on_ground=False
            ),
            # Landing
            create_test_player(
                "player1", 0, position=Vec3(0.0, 0.0, 100.0), is_on_ground=False
    ...
    def test_team_analysis_aggregation(self):
        ...
        players_frame1 = [
            create_test_player(
                "player1", 0, velocity=Vec3(500.0, 0.0, 0.0)
            ),  # Blue team
            create_test_player(
                "player2", 0, velocity=Vec3(1500.0, 0.0, 0.0)
            ),  # Blue team
            create_test_player(
                "player3", 1, velocity=Vec3(2000.0, 0.0, 0.0)
            ),  # Orange team
        ]
    ...
    def test_supersonic_flag_override(self):
        ...
        players = [
            create_test_player(
                "player1", 0, velocity=Vec3(1500.0, 0.0, 0.0), is_supersonic=True
            ),
        ]
    ...
    def test_supersonic_hysteresis_handles_minor_dips(self):
        ...
        frames = [
            create_test_frame(
                0.0, [create_test_player("player1", 0, velocity=Vec3(2300.0, 0.0, 0.0))]
            ),
            create_test_frame(
                1.0, [create_test_player("player1", 0, velocity=Vec3(2150.0, 0.0, 0.0))]
            ),
            create_test_frame(
                2.0, [create_test_player("player1", 0, velocity=Vec3(2000.0, 0.0, 0.0))]
            ),
        ]
    ...
    def test_demolished_player_handling(self):
        ...
        players = [
            create_test_player(
                "player1", 0, velocity=Vec3(1800.0, 0.0, 0.0), is_demolished=False
            ),
            create_test_player(
                "player1", 0, velocity=Vec3(0.0, 0.0, 0.0), is_demolished=True
            ),
        ]
