...
def create_test_frame(
    timestamp: float, ball_pos: Vec3, players: list[PlayerFrame]
) -> Frame:
...
class TestPositioningAnalysis:
    ...
    def test_role_detection_second_man(self):
        ...
        players = [
            ...
            create_test_player(
                "player1", 0, position=Vec3(0.0, 1500.0, 17.0)
            ),  # Second closest
            create_test_player(
                "player2", 0, position=Vec3(0.0, 500.0, 17.0)
            ),  # Closest
            create_test_player(
                "player3", 0, position=Vec3(0.0, 2500.0, 17.0)
            ),  # Furthest
        ]
    ...
    def test_role_detection_third_man(self):
        ...
        players = [
            ...
            create_test_player(
                "player1", 0, position=Vec3(0.0, 2500.0, 17.0)
            ),  # Furthest
            create_test_player(
                "player2", 0, position=Vec3(0.0, 500.0, 17.0)
            ),  # Closest
            create_test_player(
                "player3", 0, position=Vec3(0.0, 1500.0, 17.0)
            ),  # Second
        ]
    ...
    def test_distance_to_teammates_calculation(self):
        ...
        players_frame1 = [
            create_test_player("player1", 0, position=Vec3(0.0, 0.0, 17.0)),
            create_test_player(
                "player2", 0, position=Vec3(1000.0, 0.0, 17.0)
            ),  # 1000 UU away
            create_test_player(
                "player3", 0, position=Vec3(0.0, 1000.0, 17.0)
            ),  # 1000 UU away
        ]
        ...
        players_frame2 = [
            create_test_player("player1", 0, position=Vec3(0.0, 0.0, 17.0)),
            create_test_player(
                "player2", 0, position=Vec3(500.0, 0.0, 17.0)
            ),  # 500 UU away
            create_test_player(
                "player3", 0, position=Vec3(0.0, 500.0, 17.0)
            ),  # 500 UU away
        ]
    ...
    def test_team_analysis_aggregation(self):
        ...
        players = [
            ...
            create_test_player(
                "player1", 0, position=Vec3(0.0, -1000.0, 17.0)
            ),  # Defensive
            create_test_player(
                "player2", 0, position=Vec3(0.0, 1000.0, 17.0)
            ),  # Offensive
            # Orange team player
    ...
    def test_rotation_compliance_double_commit_detection(self):
        ...
        players = [
            create_test_player(
                "player1", 0, position=Vec3(100.0, 100.0, 17.0)
            ),  # Close to ball
            create_test_player(
                "player2", 0, position=Vec3(150.0, 150.0, 17.0)
            ),  # Also close
        ]
    ...
    def test_rotation_compliance_overcommit_detection(self):
        ...
        players_frame2 = [
            ...
            ),  # Offensive half, low boost, but still last man
            create_test_player(
                "player2", 0, position=Vec3(0.0, 200.0, 17.0)
            ),  # More forward
            create_test_player(
                "player3", 0, position=Vec3(0.0, 1000.0, 17.0)
            ),  # Most forward
    ...
    def test_rotation_compliance_good_positioning(self):
        ...
        players = [
            create_test_player(
                "player1", 0, position=Vec3(0.0, -1000.0, 17.0), boost_amount=50
            ),  # Back
            create_test_player(
                "player2", 0, position=Vec3(0.0, 0.0, 17.0), boost_amount=60
            ),  # Mid
            create_test_player(
                "player3", 0, position=Vec3(0.0, 800.0, 17.0), boost_amount=40
            ),  # Forward
        ]
    ...
    def test_complex_positioning_scenario(self):
        ...
        players = [
            [
                create_test_player(
                    "player1", 0, position=Vec3(0.0, -3000.0, 17.0)
                ),  # Defensive third
                create_test_player("player2", 0, position=Vec3(0.0, -1000.0, 17.0)),
            ],  # Teammate
            [
                create_test_player(
                    "player1", 0, position=Vec3(0.0, 0.0, 17.0)
                ),  # Neutral third
                create_test_player("player2", 0, position=Vec3(0.0, 1000.0, 17.0)),
            ],
            [
        ...
        assert result["time_middle_third_s"] == 1.0
        assert (
            result["time_offensive_third_s"] == 1.0
        )  # Final frame gets estimated duration
