...
_register(
    MetricDefinition(
        key="time_full_boost_s",
        display_name="Full Boost Time",
        unit="seconds",
        direction=MetricDirection.LOWER_BETTER,
        category="boost",
...
_register(
    MetricDefinition(
        key="time_offensive_third_s",
        display_name="Off. Third Time",
        unit="seconds",
        direction=MetricDirection.CONTEXT_DEPENDENT,
...
_register(
    MetricDefinition(
        key="time_middle_third_s",
        display_name="Mid Third Time",
        unit="seconds",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
...
_register(
    MetricDefinition(
        key="time_defensive_third_s",
        display_name="Def. Third Time",
        unit="seconds",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
...
_register(
    MetricDefinition(
        key="avg_distance_to_ball_m",
        display_name="Avg Dist to Ball",
        unit="meters",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
...
_register(
    MetricDefinition(
        key="avg_distance_to_teammate_m",
        display_name="Avg Teammate Dist",
        unit="meters",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
        description="Avg distance to teammate",
        valid_modes=("2v2", "3v3"),
    )
)
_register(
...
_register(
    MetricDefinition(
        key="second_man_pct",
        display_name="2nd Man %",
        unit="percent",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
        description="Time as 2nd closest to ball",
        valid_modes=("2v2", "3v3"),
    )
)
_register(
    MetricDefinition(
        key="third_man_pct",
        display_name="3rd Man %",
        unit="percent",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="positioning",
        description="Time as 3rd closest to ball",
        valid_modes=("3v3",),
    )
)
...
_register(
    MetricDefinition(
        key="challenge_losses",
        display_name="50/50 Losses",
        unit="count",
        direction=MetricDirection.LOWER_BETTER,
        category="challenges",
...
_register(
    MetricDefinition(
        key="first_to_ball_pct",
        display_name="First to Ball %",
        unit="percent",
        direction=MetricDirection.HIGHER_BETTER,
        category="challenges",
...
_register(
    MetricDefinition(
        key="kickoffs_participated",
        display_name="Kickoffs",
        unit="count",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="kickoffs",
...
_register(
    MetricDefinition(
        key="kickoff_first_touches",
        display_name="Kickoff First Touches",
        unit="count",
        direction=MetricDirection.CONTEXT_DEPENDENT,
        category="kickoffs",
...
_register(
    MetricDefinition(
        key="flip_cancel_count",
        display_name="Flip Cancels",
        unit="count",
        direction=MetricDirection.HIGHER_BETTER,
        category="mechanics",
...
_register(
    MetricDefinition(
        key="avg_recovery_momentum",
        display_name="Recovery Quality",
        unit="0-100",
        direction=MetricDirection.HIGHER_BETTER,
        category="recovery",
...
_register(
    MetricDefinition(
        key="time_shadow_defense_s",
        display_name="Shadow Time",
        unit="seconds",
        direction=MetricDirection.HIGHER_BETTER,
        category="defense",
